...
@NgModule({
  ...
  declarations: [AddTaskComponent, TaskDetailComponent, ImportLogsComponent],
  exports: [AddTaskComponent, TaskDetailComponent, ImportLogsComponent, FormatWorkHoursPipe]
})
